          ...
          <div className="formatSelect ">
            ...
            <div className="formatControler">
              <FormControl className="formControl">
                ...
                >
                  <Typography className="mb-5">انتخاب کنید</Typography>
                </InputLabel>
                <Select
                  id="type_id"
                  name="type_id"
                ...
                >
                  ...
                  {types?.map((types) => (
                    <MenuItem value={types.id}>
                      <Typography className="">{types.title}</Typography>
                    </MenuItem>
                  ))}
                </Select>
              </FormControl>
              ...
              <FormControl className="formControl ">
                ...
                >
                  ...
                  {equipments?.map((equipments) => (
                    <MenuItem className="dir:rtl" value={equipments.id}>
                      <Typography>{equipments.title}</Typography>
                    </MenuItem>
                  ))}
                </Select>
              </FormControl>
            ...
            <div className="formatControler">
              <FormControl className="formControl">
                ...
                >
                  ...
                  {muscles?.map((muscle) => (
                    <MenuItem value={muscle.id}>
                      <Typography>{muscle.title}</Typography>
                    </MenuItem>
                  ))}
                </Select>
              </FormControl>
