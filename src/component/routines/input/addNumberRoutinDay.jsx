...
const InputAddNumberRoutinDay = ({
  ...
  if (amountDay[0]?.index_id == Index_Id) {
    newamount = amountDay[0]?.amount;
  }
  ...
  useEffect(() => {
    dispatch(
      setUpdateInputNumber({ number, newamount, IndexSet, Id, SetId, Index_Id })
    );
  }, [number]);
