...
import {
  createUpdateRoutes,
  setUpdateRoutes,
} from "../../../store/slice/updateRoutineSlice";
...
const EditeRoutin = () => {
  ...
  useEffect(() => {
    routinApi
      ...
      .then((result) => dispatch(setRoutes(result.data.data)))
      .then(setSuccessAPI(false));
  }, []);
                  ...
                  <>
                    <Card className="" sx={{ maxWidth: 700, marginTop: 5 }}>
                        ...
                        >
                          <TableHead>
                            <TableRow className="">
                              ...
                              {routes.exercise?.type?.indices?.map((type) => (
                      ...
                      <Grid sx={{ m: 3 }} xs={12}>
                        <Button
                          sx={{ width: "100%" }}
                          onClick={() => handleUpdateAddSet(routes.id)}
                          size={"large"}
                          variant="contained"
                        >
                          + Add Set
