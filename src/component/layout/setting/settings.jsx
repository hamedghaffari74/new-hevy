        ...
        <div item className=" md:flex lg:flex sm:w-full justify-end ">
          ...
          >
            ...
            <a>
              <ListItem>
                <div className="listItemSetting ">
                  <Typography>مدیریت اشتراک </Typography> <samp samp>PRO </samp>
                </div>
                <ArrowBackIosNewIcon />
              </ListItem>
            </a>
          ...
          {profile ? (
            ...
            <div>
              ...
              <Typography className="">
                داشتن یک نمایه خصوصی به این معنی است که سایر کاربران باید
                درخواست کنند تا شما را دنبال کنند. فقط اگر درخواست فالو آنها را
                بپذیرید، می توانند تمرینات شما را ببینند
              </Typography>
              <Box
              ...
              >
                <label for="CurrentPassword">
                  <Typography>کلمه عبور قبلی</Typography>
                </label>
                <Input
                  id="CurrentPassword"
                  type="text"
