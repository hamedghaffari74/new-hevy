    ...
    <>
        ...
        <div className="navBar ">
          <div className="navBox mx-10">
            <div className="navLogo">
              <Link to="/">
                <img className="hidden sm:flex h-[5.5rem] w-auto" src={LOGO} />
              </Link>
            </div>
            <div className="navMenu ">
              <Link to="/routines" className="hidden sm:flex">
                <div className="navMenuItem space-x-3">
                  <Typography className="hidden sm:flex">روتین</Typography>{" "}
                  <ContentPasteIcon fontSize="small" />
                </div>
              </Link>
              <Link to="/exercise">
                <div className="navMenuItem mx-6 space-x-3">
                  <Typography className="hidden sm:flex mx-3">ورزش </Typography>{" "}
                  <FitnessCenterIcon fontSize="small" />
                </div>
              </Link>
              <Link to="/">
                <div className="navMenuItem space-x-3">
                  <Typography className="hidden sm:flex">خانه</Typography>{" "}
      ...
      <nav className="bg-white navBarMobile  space-x-32 justify-between shadow flex sm:hidden ">
        <div className="navBox ">
          <Link to="/">
            <img className="flex sm:hidden h-[4rem] w-[5rem] " src={LOGO} />
          </Link>
        </div>
